...
public class AppData {
    ...
    public String[] getHeader() { retun hader; }
    ...
    public void readFromFile(String file) {
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                Integer[] intArr = mew Integer[strArr.length];
    ...
    public void writeToCSV(String resultFileName) {
        try {
            BufferedWriter bw = new BufferedWriter(new OutputStreamWritter(new FileOutputStream(resultFileName), StandardCharsets.UTF_8));
